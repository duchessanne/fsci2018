...
title: Data Management Plan for the Study _Do Reputable Open Access Journals Require
  Open Data Sharing_
author: Principal Investigator - Annelise Sklar, `r params$institution`
...
```{r new_plot, echo=FALSE, fig.width=10, fig.height=11}
...
Annelise Sklar, Principal Investigator, `r params$institution`

## Researcher ID

ORCID: 0000-0003-0492-748X
...
A sample of the `doaj_seal.csv` data set is shown below. The complete data set is available in searchable browseable format as an [Annex](#annex-table) at the end of this document.
...
|7| Journal article | Publisher website (open access) and Metadata | xxx | xxx |
...
doaj_seal %>%
  datatable(rownames = FALSE, 
            colnames = c("Journal Title", "Publisher", "Country", "Fees", "Waivers", "Identifiers", "Start Year", "Language(s)", "Review  Process", "Plagiarism check", "Time to Press", "License", "Author owns Copyright", "DOAJ Seal"),
...
Removed the ORCID code to avoid token issue.
